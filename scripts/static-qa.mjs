...
if (await exists('shared-menu.js')) {
  const sharedMenu = await read('shared-menu.js');
  for (const marker of ['dock-home', 'dock-coverage', 'ticker-menu-toggle', 'ticker-control', 'ticker-step', 'data-step="previous"', 'data-step="next"', 'aria-current', 'safe-area-inset-bottom', "['home', 'coverage', 'ticker']", "addEventListener('touchstart'", "addEventListener('touchend'", 'grid-template-rows:auto minmax(0,1fr)', 'overscroll-behavior:contain', 'elliott:ticker-updated']) {
