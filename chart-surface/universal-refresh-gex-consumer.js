(function (root) {
  ...
  function resolveExpiration(record, group) {
    ...
    const renderChart = expiry.status === 'renderable' && expiry.exposureType === 'signed_dealer_gex' && numericProfile;
    ...
    return {renderChart, status: expiry.status, reason, profile: renderChart ? expiry : null};
  }
